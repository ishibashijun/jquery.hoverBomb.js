...
c[d]?"&nbsp;":c[d])+"</span>";return a},d=function(c,d,e){return c?d?e?Math.random()*(d-c)+c:Math.round(Math.random()*(d-c)+c):Math.round(Math.random()*c):Math.random()},l=function(c){c.css({top:0,left:0,"-webkit-transform":"rotate(0deg)","-moz-transform":"rotate(0deg)","-ms-transform":"rotate(0deg)","-o-transform":"rotate(0deg)",transform:"rotate(0deg)"})}})(jQuery);
